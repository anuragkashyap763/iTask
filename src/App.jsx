...
//       return;
//     } else {
//       setTodos([...todos, { todo, isCompleted: false, id: uuidv4(), animating: false }]); //✅ replaced manual id with uuidv4()
...
//       <div className="container mx-auto my-5 rounded-xl p-5 bg-violet-200 min-h-screen flex flex-col overflow-hidden">
//         {/* ✅ Add Todo Section */}
...
//         {/* ✅ Finished Todos Section */}
//         <div
//           className={`finishedTodos bg-violet-100 p-3 rounded-xl mb-5 w-full sm:w-3/4 mx-auto transform transition-all duration-500 ease-in-out ${
//             showFinished
...
//         <div className="flex-1 overflow-y-auto p-2 rounded-xl bg-violet-100 shadow-inner text-left">
...
//               <div
//                 key={item.id}
//                 className={`todo flex flex-col sm:flex-row items-start sm:items-center justify-between py-3 border-b border-violet-300 transition-all duration-500 ease-in-out ${
//                   item.animating
